function CalendarApp(date) {
    ...
    this.days = ['Nedelja', 'Ponedeljak', 'Utorak', 'Sreda', 'Četvrtak', 'Petak', 'Subota'];
    this.months = ['Jan', 'Feb', 'Mar', 'Apr', 'Maj', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dec'];
    this.quotes = ['Život je ili izazovna avantura, ili ništa. -Helen Keler','Radite ono što možete, gde god bili, sa onim što imate. -Tedi Ruzvelt','Uzmite svoj život u svoje ruke, i šta će se desiti? Strašna stvar, za koju nećete imati koga da okrivite. -Erika Jong','Dva najvažnija dana u vašem životu su dan kada ste rođeni i dan kada ste shvatili za šta ste rođeni. -Mark Tvejn','Bilo da mislite da možete, ili mislite da ne možete, u oba slučaja ste u pravu. -Henri Ford','Život čini 10% onoga što mi se dešava i 90% toga kako ja reagujem na to. -Čarls Svindol','Najbolji način da predvidite budućnost je da je stvorite. -Abraham Linkoln','Jedan čovek sa hrabrošću čini većinu. -Andru Džekson'];
    this.apts = [
        //jun
      {
        name: 'Đubre',
        endTime: new Date(2021, 5, 17, 11),
        startTime: new Date(2021, 5, 17, 9),
        day: new Date(2021, 5, 17).toString()
      },
       {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 5, 18, 11),
        startTime: new Date(2021, 5, 18, 9),
        day: new Date(2021, 5, 18).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 5, 18, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 5, 25, 11),
        startTime: new Date(2021, 5, 25, 9),
        day: new Date(2021, 5, 25).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 5, 25, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 5, 11, 11),
        startTime: new Date(2021, 5, 11, 9),
        day: new Date(2021, 5, 11).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 5, 11, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 6, 2, 11),
        startTime: new Date(2021, 6, 2, 9),
        day: new Date(2021, 6, 2).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 6, 2, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 6, 9, 11),
        startTime: new Date(2021, 6, 9, 9),
        day: new Date(2021, 6, 9).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 6, 9, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 6, 16, 11),
        startTime: new Date(2021, 6, 16, 9),
        day: new Date(2021, 6, 16).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 6, 16, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 6, 23, 11),
        startTime: new Date(2021, 6, 23, 9),
        day: new Date(2021, 6, 23).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 6, 23, 11),
      ...
      {
        name: 'Hrana i otpad iz dvorišta',
        endTime: new Date(2021, 6, 30, 11),
        startTime: new Date(2021, 6, 30, 9),
        day: new Date(2021, 6, 30).toString()
      },
      {
        name: 'Recikliranje',
        endTime: new Date(2021, 6, 30, 11),
      ...
      {
        name: 'Đubre',
        endTime: new Date(2021, 6, 1, 11),
        startTime: new Date(2021, 6, 1, 9),
        day: new Date(2021, 6, 1).toString()
      },
      {
        name: 'Đubre',
        endTime: new Date(2021, 6, 15, 11),
        startTime: new Date(2021, 6, 15, 9),
        day: new Date(2021, 6, 15).toString()
      },
      {
        name: 'Đubre',
        endTime: new Date(2021, 6, 29, 11),
        startTime: new Date(2021, 6, 29, 9),
        day: new Date(2021, 6, 29).toString()
      },
      
    ];
    
    this.aptDates = [new Date(2021, 6, 1).toString(),new Date(2021, 6, 15).toString(),new Date(2021, 6, 30).toString(),new Date(2021, 6, 23).toString(),new Date(2021, 6, 16).toString(),new Date(2021, 6, 9).toString(),new Date(2021, 6, 2).toString(),new Date(2021, 6, 29).toString(),new Date(2021, 5, 17).toString(),new Date(2021, 5, 18).toString(), new Date(2021, 5, 25).toString(),new Date(2021, 5, 11).toString()];
    this.eles = {
    };
    ...
    this.todayIsSpan.textContent = "Danas je " + this.months[date.getMonth()] + " " + date.getDate();  
  }
  ...
  CalendarApp.prototype.openDayWindow = function(date){
    ...
    this.dayEventsEle.textContent = _dayTopbarText + "dešavanja na dan " + this.months[day.getMonth()] + " " + day.getDate() + ", " + day.getFullYear();
  ...
  CalendarApp.prototype.showEventsCreateElesView = function(events) {
    ...
    events.forEach(function(event){
      ...
      var html = "<span class='start-time'>" + _start.toLocaleTimeString(navigator.language,{hour: '2-digit', minute:'2-digit'}) + "</span> <small>do</small> ";
      html += "<span class='end-time'>" + _end.toLocaleTimeString(navigator.language,{hour: '2-digit', minute:'2-digit'}) + ( (_end.getDate() != _start.getDate()) ? ' <small>dana ' + _end.toLocaleDateString() + "</small>" : '') +"</span>";
      ...
      var deleteText = document.createTextNode("izbriši");
